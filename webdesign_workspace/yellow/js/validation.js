var joinValidate = {
	...
	checkPw: function(pw, rpw){
		...
		//체인식으로 연결이 되어있으니 위에부터 차례로 읽어들어가야 하낟.\\
    ...
    checkName : function(name) {
    	...
    	}else if(name.length < 2 || name.length > 20){//3 2~20자 길이
